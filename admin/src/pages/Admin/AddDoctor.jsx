    ...
    return (
        <form onSubmit={onSubmitHandler} className='m-5 w-full'>
            ...
            <div className='bg-white px-8 py-8 border rounded w-full max-w-4xl max-h-[80vh] overflow-y-scroll'>
                    ...
                    <div className='w-full lg:flex-1 flex flex-col gap-4'>
                        ...
                        <div className='flex-1 flex flex-col gap-1'>
                            ...
                            <div className='relative'>
                                <input onChange={e => setPassword(e.target.value)} value={password} className='border rounded px-3 py-2 w-full pr-10' type={showPassword ? 'text' : 'password'} placeholder='Password' required />
                                <button
                                    type='button'
                        ...
                        <div className='flex-1 flex flex-col gap-1'>
                            <p>Experience</p>
                            <input onChange={e => setExperience(e.target.value)} value={experience} className='border rounded px-3 py-2' type="text" placeholder="e.g. '1' year/s" required />
                        </div>
                ...
                <button type='submit' className='bg-gradient-to-r from-blue-500 to-green-500 hover:from-blue-600 hover:to-green-600 text-white px-10 py-3 mt-4 rounded-full transition-all duration-300 shadow-md hover:shadow-lg'>Add doctor</button>
