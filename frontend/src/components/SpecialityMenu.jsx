            ...
            <div className='max-w-7xl mx-auto'>
                ...
                <div className='grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4 sm:gap-6'>
                    {specialityData.map((item, index) => (
                        ...
                        >
                            <div className='relative flex flex-col items-center p-6 sm:p-8 bg-white dark:bg-slate-800 rounded-2xl shadow-lg hover:shadow-2xl dark:shadow-slate-900/50 transition-all duration-500 ease-out hover:-translate-y-3 border border-gray-100 dark:border-slate-700 hover:border-blue-200 dark:hover:border-blue-800 overflow-hidden'>
